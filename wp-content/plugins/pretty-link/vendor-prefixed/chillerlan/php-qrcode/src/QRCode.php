...
namespace PrettyLinks\chillerlan\QRCode;

use PrettyLinks\chillerlan\QRCode\Common\{
	EccLevel, ECICharset, GDLuminanceSource, IMagickLuminanceSource, LuminanceSourceInterface, MaskPattern, Mode, Version
};
use PrettyLinks\chillerlan\QRCode\Data\{AlphaNum, Byte, ECI, Hanzi, Kanji, Number, QRData, QRDataModeInterface, QRMatrix};
use PrettyLinks\chillerlan\QRCode\Decoder\{Decoder, DecoderResult};
use PrettyLinks\chillerlan\QRCode\Output\{QRCodeOutputException, QROutputInterface};
use PrettyLinks\chillerlan\Settings\SettingsContainerInterface;
...
class QRCode{
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Common\Version::AUTO
	 * @var int
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Common\MaskPattern::AUTO
	 * @var int
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Common\EccLevel::L
	 * @var int
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Common\EccLevel::M
	 * @var int
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Common\EccLevel::Q
	 * @var int
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Common\EccLevel::H
	 * @var int
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::MARKUP_HTML
	 * @var string
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::MARKUP_SVG
	 * @var string
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::GDIMAGE_PNG
	 * @var string
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::GDIMAGE_JPG
	 * @var string
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::GDIMAGE_GIF
	 * @var string
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::STRING_JSON
	 * @var string
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::STRING_TEXT
	 * @var string
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::IMAGICK
	 * @var string
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::FPDF
	 * @var string
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::EPS
	 * @var string
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::CUSTOM
	 * @var string
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputInterface::MODES
	 * @var string[]
	 */
	 ...
	 *
	 * @var \PrettyLinks\chillerlan\QRCode\QROptions|\PrettyLinks\chillerlan\Settings\SettingsContainerInterface
	 */
	 ...
	 *
	 * @var \PrettyLinks\chillerlan\QRCode\Data\QRDataModeInterface[]
	 */
	...
	public function render(?string $data = null, ?string $file = null){
		...
		if($data !== null){
			/** @var \PrettyLinks\chillerlan\QRCode\Data\QRDataModeInterface $dataInterface */
	 ...
	 *
	 * @throws \PrettyLinks\chillerlan\QRCode\Data\QRCodeDataException
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\QRCode::getQRMatrix()
	 * @codeCoverageIgnore
	 */
	 ...
	 *
	 * @throws \PrettyLinks\chillerlan\QRCode\Output\QRCodeOutputException
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Data\Number::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Data\AlphaNum::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Data\Kanji::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Data\Byte::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 *
	 * @throws \PrettyLinks\chillerlan\QRCode\QRCodeException
	 */
