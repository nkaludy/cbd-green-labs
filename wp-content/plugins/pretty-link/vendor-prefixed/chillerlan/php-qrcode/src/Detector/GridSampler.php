...
final class GridSampler{
	 ...
	 *
	 * @throws \PrettyLinks\chillerlan\QRCode\Detector\QRCodeDetectorException if an endpoint is lies outside the image boundaries
	 */
	 ...
	 * image space.
	 *
	 * @return \PrettyLinks\chillerlan\QRCode\Decoder\BitMatrix representing a grid of points sampled from the image within a region
	 *   defined by the "from" parameters
	 * @throws \PrettyLinks\chillerlan\QRCode\Detector\QRCodeDetectorException if image can't be sampled, for example, if the transformation defined
