...
final class AlignmentPatternFinder{
	...
	/** @var \PrettyLinks\chillerlan\QRCode\Detector\AlignmentPattern[] */
	private array $possibleCenters;

	/**
	 * Creates a finder that will look in a portion of the whole image.
	 *
	 * @param \PrettyLinks\chillerlan\QRCode\Decoder\BitMatrix $matrix     image to search
	 ...
	 *
	 * @return \PrettyLinks\chillerlan\QRCode\Detector\AlignmentPattern|null
	 */
	 ...
	 *
	 * @return \PrettyLinks\chillerlan\QRCode\Detector\AlignmentPattern|null if we have found the same pattern twice, or null if not
	 */
