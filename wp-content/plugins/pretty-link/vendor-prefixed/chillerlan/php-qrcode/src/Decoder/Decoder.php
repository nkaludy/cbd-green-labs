...
use PrettyLinks\chillerlan\QRCode\Common\{BitBuffer, EccLevel, LuminanceSourceInterface, MaskPattern, Mode, Version};
use PrettyLinks\chillerlan\QRCode\Data\{AlphaNum, Byte, ECI, Hanzi, Kanji, Number};
use PrettyLinks\chillerlan\QRCode\Detector\Detector;
use Throwable;
...
final class Decoder{
	 ...
	 *
	 * @throws \Throwable|\PrettyLinks\chillerlan\QRCode\Decoder\QRCodeDecoderException
	 */
	...
	/**
	 * @throws \PrettyLinks\chillerlan\QRCode\Decoder\QRCodeDecoderException
	 */
