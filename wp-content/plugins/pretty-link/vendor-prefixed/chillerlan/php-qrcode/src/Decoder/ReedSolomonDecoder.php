...
use PrettyLinks\chillerlan\QRCode\Common\{BitBuffer, EccLevel, GenericGFPoly, GF256, Version};
...
final class ReedSolomonDecoder{
	 ...
	 *
	 * @return int[]
	 * @throws \PrettyLinks\chillerlan\QRCode\Decoder\QRCodeDecoderException if decoding fails for any reason
	 */
	...
	/**
	 * @return \PrettyLinks\chillerlan\QRCode\Common\GenericGFPoly[] [sigma, omega]
	 * @throws \PrettyLinks\chillerlan\QRCode\Decoder\QRCodeDecoderException
	 */
