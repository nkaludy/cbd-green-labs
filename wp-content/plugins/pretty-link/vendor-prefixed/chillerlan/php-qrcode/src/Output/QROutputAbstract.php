...
namespace PrettyLinks\chillerlan\QRCode\Output;

use PrettyLinks\chillerlan\QRCode\Data\QRMatrix;
...
abstract class QROutputAbstract implements QROutputInterface{
	 ...
	 *
	 * @see \PrettyLinks\chillerlan\QRCode\Data\QRMatrix::getSize()
	 */
	...
	/**
	 * @var \PrettyLinks\chillerlan\Settings\SettingsContainerInterface|\PrettyLinks\chillerlan\QRCode\QROptions
	 */
	protected SettingsContainerInterface $options;

	/** @see \PrettyLinks\chillerlan\QRCode\QROptions::$scale */
	protected int $scale;
	/** @see \PrettyLinks\chillerlan\QRCode\QROptions::$connectPaths */
	protected bool $connectPaths;
	/** @see \PrettyLinks\chillerlan\QRCode\QROptions::$excludeFromConnect */
	protected array $excludeFromConnect;
	/** @see \PrettyLinks\chillerlan\QRCode\QROptions::$eol */
	protected string $eol;
	/** @see \PrettyLinks\chillerlan\QRCode\QROptions::$drawLightModules */
	protected bool $drawLightModules;
	/** @see \PrettyLinks\chillerlan\QRCode\QROptions::$drawCircularModules */
	protected bool $drawCircularModules;
	/** @see \PrettyLinks\chillerlan\QRCode\QROptions::$keepAsSquare */
	protected array $keepAsSquare;
	/** @see \PrettyLinks\chillerlan\QRCode\QROptions::$circleRadius */
	 ...
	 * @throws \PrettyLinks\chillerlan\QRCode\Output\QRCodeOutputException if $moduleValues[$M_TYPE] doesn't exist
	 */
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\QROptions::$cachefile
	 *
	 ...
	 * @see \PrettyLinks\chillerlan\QRCode\Output\QROutputAbstract::moduleTransform()
	 */
