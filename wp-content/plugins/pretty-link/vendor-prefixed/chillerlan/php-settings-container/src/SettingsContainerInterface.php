...
namespace PrettyLinks\chillerlan\Settings;
...
interface SettingsContainerInterface extends JsonSerializable{
	...
	/**
	 * @see \PrettyLinks\chillerlan\Settings\SettingsContainerInterface::toJSON()
	 */
	 ...
	 *
	 * @see \json_encode()
	 * @see \PrettyLinks\chillerlan\Settings\SettingsContainerInterface::toArray()
	 *
	 ...
	 *
	 * @see \PrettyLinks\chillerlan\Settings\SettingsContainerInterface::fromIterable()
	 *
	 * @throws \Exception
	 * @throws \JsonException
	 */
