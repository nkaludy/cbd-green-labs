<?php
/**
   * PrettyLinks_Spyc -- A Simple PHP YAML Class
   * @version 0.6.2
   ...
   * @package PrettyLinks_Spyc
   */

if (!function_exists('prettylinks_spyc_load')) {
  /**
   * Parses YAML to array.
   * @param string $string YAML string.
   * @return array
   */
  function prettylinks_spyc_load ($string) {
    return PrettyLinks_Spyc::YAMLLoadString($string);
  }
}

if (!function_exists('prettylinks_spyc_load_file')) {
  /**
   * Parses YAML to array.
   * @param string $file Path to YAML file.
   * @return array
   */
  function prettylinks_spyc_load_file ($file) {
    return PrettyLinks_Spyc::YAMLLoad($file);
  }
}

if (!function_exists('prettylinks_spyc_dump')) {
  /**
   * Dumps array to YAML.
   * @param array $data Array.
   * @return string
   */
  function prettylinks_spyc_dump ($data) {
    return PrettyLinks_Spyc::YAMLDump($data, false, false, true);
  }
}

if (!class_exists('PrettyLinks_Spyc')) {
...
/**
   ...
   * Usage:
   * <code>
   *   $Spyc  = new PrettyLinks_Spyc;
   *   $array = $Spyc->load($file);
   * </code>
   * or:
   * <code>
   *   $array = PrettyLinks_Spyc::YAMLLoad($file);
   * </code>
   * or:
   * <code>
...
/**
 * Load a valid YAML string to PrettyLinks_Spyc.
 * @param string $input
 * @return array
 */
 ...
 /**
 * Load a valid YAML file to PrettyLinks_Spyc.
 * @param string $file
 * @return array
 */
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = PrettyLinks_Spyc::YAMLLoad('lucky.yaml');
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = PrettyLinks_Spyc::YAMLLoadString("---\n0: hello world\n");
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
...
// Enable use of PrettyLinks_Spyc from command line
// The syntax is the following: php PrettyLinks_Spyc.php spyc.yaml

do {
  if (PHP_SAPI != 'cli') break;
  if (empty ($_SERVER['argc']) || $_SERVER['argc'] < 2) break;
  if (empty ($_SERVER['PHP_SELF']) || FALSE === strpos ($_SERVER['PHP_SELF'], 'PrettyLinks_Spyc.php') ) break;
  $file = $argv[1];
  echo json_encode (prettylinks_spyc_load_file ($file));
} while (0);
